...
-Xjvm-default=all-compatibility  In addition to the 'all' mode, generate compatibility stubs in the DefaultImpls classes.
                                 ...
                                 New 'all' and 'all-compatibility' modes are changing library ABI surface that will be used by clients after
                                 ...
                                 In case of inheritance from a Kotlin interface compiled in the 'disable' mode (DefaultImpls, no default methods),
                                 DefaultImpls compatibility stubs will delegate to the DefaultImpls methods of the superinterface.
                                 ...
                                 Perform additional compatibility checks for classes which override generic interface methods with bodies:
                                 unlike in the 'disable' mode, the compiler will report an error if such method is not overridden explicitly
                                 (see KT-39603 for more details).
